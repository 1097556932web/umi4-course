...
import { Outlet, useAppData, useNavigate, useLocation, useRoutes } from "umi";
...
const unaccessible = ["/dataflow/hook", "/dataflow/useEffect", "/dataflow/useModel", "/dataflow/useState", "/mypage"];//不可访问的
